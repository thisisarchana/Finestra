...
// Validate ../../../app/api/chat-advisor/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/chat-advisor">> = Specific
  const handler = {} as typeof import("../../../app/api/chat-advisor/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

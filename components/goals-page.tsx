  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#caf0f8] via-[#90e0ef] to-[#00b4d8] p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-black text-gray-800 flex items-center gap-3">
              <Target className="w-10 h-10 text-[#0077b6]" />
              Financial Goals
            </h1>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button className="bg-gradient-to-r from-[#0077b6] to-[#00b4d8] text-white px-6 py-3 rounded-full font-bold flex items-center gap-2 hover:shadow-lg transition-shadow">
              ...
              {showSuggestions ? (
                <div className="space-y-4 py-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {SUGGESTED_GOALS.map((goal, index) => (
                      <Card
                        key={index}
                        className="p-4 cursor-pointer hover:shadow-lg transition-all border-2 border-[#00b4d8] hover:border-[#0077b6]"
                      ...
                      >
                        ...
                        <p className="text-xs font-bold text-[#0077b6]">{formatRupees(goal.target)}</p>
                      </Card>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-4 py-4">
                  ...
                  <div className="flex justify-end gap-3 pt-4">
                    ...
                    <Button
                      onClick={addGoal}
                      className="bg-gradient-to-r from-[#0077b6] to-[#00b4d8] text-white font-bold"
                    >
                      Create Goal
                    </Button>
                  </div>
          ...
          {goals.length > 0 ? (
            goals.map((goal) => {
              ...
              return (
                <Card
                  key={goal.id}
                  className="bg-white border-2 border-[#00b4d8] rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all"
                >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="w-full h-6 bg-gray-200 rounded-full overflow-hidden border-2 border-[#00b4d8]">
                      <div
                        className="h-full bg-gradient-to-r from-[#0077b6] to-[#00b4d8] transition-all duration-500 flex items-center justify-end pr-2"
            ...
            <Card className="bg-white border-2 border-[#00b4d8] rounded-2xl p-12 text-center shadow-lg">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-gradient-to-r from-[#0077b6] to-[#00b4d8] text-white px-6 py-3 rounded-full font-bold inline-flex items-center gap-2 hover:shadow-lg transition-shadow">
                    <Plus className="w-5 h-5" />
        ...
        {goals.length > 0 && (
          <Card className="bg-gradient-to-br from-[#caf0f8] to-[#90e0ef] border-2 border-[#00b4d8] rounded-2xl p-8 mt-8 shadow-lg">

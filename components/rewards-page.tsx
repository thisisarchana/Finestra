...
export default function RewardsPage() {
  const { transactions, userName } = useTransactions()
  ...
  const getCurrentBadge = () => {
    if (totalPoints >= 500) return { level: "Gold", icon: "🥇", color: "from-[#00b4d8] to-[#0077b6]", nextPoints: null }
    if (totalPoints >= 250)
      return { level: "Silver", icon: "🥈", color: "from-[#90e0ef] to-[#caf0f8]", nextPoints: 500 }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#caf0f8] via-[#90e0ef] to-[#00b4d8] p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Level Progress */}
        <Card className="bg-gradient-to-r from-[#00b4d8] to-[#0077b6] border-0 rounded-2xl p-8 mb-12 text-white shadow-xl">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <Medal className="w-8 h-8 text-[#0077b6]" />
            <h3 className="text-2xl font-black text-gray-800">Community Leaderboard</h3>
          </div>
          {totalPoints > 0 ? (
            <Card className="bg-white border-2 border-[#00b4d8] rounded-2xl overflow-hidden shadow-lg">
              <div className="bg-gradient-to-r from-[#0077b6] to-[#00b4d8] p-6 text-white">
                  ...
                  {LEADERBOARD_USERS.slice(0, 8).map((user, index) => (
                    <div
                      ...
                      className={`flex items-center justify-between p-4 rounded-xl transition-all ${
                        index < 3
                          ? "bg-gradient-to-r from-[#caf0f8] to-[#90e0ef] border-2 border-[#00b4d8]"
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="text-2xl font-black text-[#0077b6]">{user.points}</p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { level: "Silver", points: 250, color: "from-[#90e0ef] to-[#caf0f8]", icon: "🥈" },
              { level: "Gold", points: 500, color: "from-[#00b4d8] to-[#0077b6]", icon: "🥇" },
            ].map((badge) => (
              <Card
                key={badge.level}

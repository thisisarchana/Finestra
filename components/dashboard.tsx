...
export default function Dashboard() {
  ...
  const stats = useMemo(() => {
    ...
    console.log("[v0] Dashboard - Last 30 days transactions:", currentMonthTransactions.length)
    ...
    const monthlyExpenses = totalExpenses // Already filtered to last 30 days
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#03045e] via-[#0077b6] to-[#03045e] p-6 dark">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Budget Card - Main */}
        <Card className="bg-gradient-to-br from-[#00b4d8] to-[#0077b6] border-0 shadow-2xl mb-8 p-8 text-white rounded-3xl">
          <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-slate-800/50 border-2 border-[#00b4d8]/30 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow hover:border-[#00b4d8]/60 dark">
            <div className="flex items-center justify-between mb-4">
              <span className="text-3xl">📈</span>
              <ArrowUpRight className="w-6 h-6 text-green-400" />
            </div>
            <p className="text-gray-400 text-sm mb-2">Total Income (Last 30 Days)</p>
            <p className="text-3xl font-black text-[#90e0ef]">{formatRupees(stats.totalIncome)}</p>
            <p className="text-xs text-green-400 mt-2">↑ Last 30 days</p>
          </Card>

          <Card className="bg-slate-800/50 border-2 border-[#0077b6]/30 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow hover:border-[#0077b6]/60 dark">
            <div className="flex items-center justify-between mb-4">
              <span className="text-3xl">💸</span>
              <ArrowDownLeft className="w-6 h-6 text-red-400" />
            </div>
            <p className="text-gray-400 text-sm mb-2">Total Expenses (Last 30 Days)</p>
            <p className="text-3xl font-black text-[#00b4d8]">{formatRupees(stats.totalExpenses)}</p>
            <p className="text-xs text-red-400 mt-2">Last 30 days</p>
          </Card>

          <Card className="bg-slate-800/50 border-2 border-[#90e0ef]/30 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow hover:border-[#90e0ef]/60 dark">
            <div className="flex items-center justify-between mb-4">
              <span className="text-3xl">🎯</span>
              <Zap className="w-6 h-6 text-yellow-400" />
            </div>
            <p className="text-gray-400 text-sm mb-2">Saved (Last 30 Days)</p>
            <p className="text-3xl font-black text-[#caf0f8]">{formatRupees(stats.savings)}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          {/* Pie Chart */}
          <Card className="bg-slate-800/50 border-2 border-[#00b4d8]/20 rounded-2xl p-6 shadow-lg dark leading-4">
          ...
          {/* Line Chart */}
          <Card className="bg-slate-800/50 border-2 border-[#0077b6]/20 rounded-2xl p-6 shadow-lg dark">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          {/* Recent Transactions */}
          <Card className="lg:col-span-2 bg-slate-800/50 border-2 border-[#90e0ef]/20 rounded-2xl p-6 shadow-lg dark">
        ...
        {/* AI Insights */}
        <Card className="bg-gradient-to-br from-[#0077b6]/20 via-[#00b4d8]/10 to-[#90e0ef]/20 border-2 border-[#00b4d8]/50 rounded-2xl p-6 shadow-lg dark">
          ...
          <div className="space-y-4">
            {stats.categoryData.length > 0 && (
              <div className="bg-slate-800/60 rounded-lg p-4 border border-[#00b4d8]/20">
                <p className="text-sm font-bold text-[#90e0ef] mb-2">💡 Quick Tip</p>
            ...
            <div className="bg-slate-800/60 rounded-lg p-4 border border-[#00b4d8]/20">
              <p className="text-sm font-bold text-[#00b4d8] mb-2">🔔 Alert</p>
              <p className="text-sm text-gray-300">
